...
package
{
	...
	/**	
	 * Sample application for using the TenjinSDK Native Extension
	 */
	public class TestTenjinSDK extends Sprite
	{
		...
		private function init( ):void
		{
			try
			{
				message( "TenjinSDK Supported: " + TenjinSDK.isSupported );
				message( "TenjinSDK Version:   " + TenjinSDK.service.version );
