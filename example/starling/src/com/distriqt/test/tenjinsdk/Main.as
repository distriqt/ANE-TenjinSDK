...
package com.distriqt.test.tenjinsdk
{
	...
	public class Main extends Sprite implements ILogger
	{
		...
		private var _tests		: TenjinSDKTests;
		...
		private function createUI():void
		{
			...
			_tests = new TenjinSDKTests( this );

			
			addAction( "Init", _tests.init );
			addAction( "Connect", _tests.connect );
			
			addAction( "Opt In", _tests.optIn );
			addAction( "Opt Out", _tests.optOut );
			
			addAction( "Send Event", _tests.sendEvent );
			addAction( "Send Event With Value", _tests.sendEventWithValue );
			
			addAction( "Transaction", _tests.transaction );
